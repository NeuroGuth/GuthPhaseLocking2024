function [] = tg_trialInfoDiagnostics_20200511(cfg, trialInfo)
%
% tg_trialInfoDiagnostics_20200511 produces several figures to double-check
% the extraction of behavioral information from the logfile.

%% first time (subtract from other timepoints to reduce size of numbers)
...
arenaRadius = 50; % according to Ansh Patel
